...
function scene:create( event )
    ...
    local function handleButtonEvent2( event )
        composer.removeScene("menu")
        composer.gotoScene("alluserstats", { effect = "crossFade", time = 500 } )
        return true
    end
    ...
    local function handleButtonEvent4( event )
        composer.removeScene("menu")
        composer.gotoScene("about", { effect = "crossFade", time = 500 } )
        return true
    end
    ...
    local button4 = mui.newRoundedRectButton({
        parent = sceneGroup,
        name = "About",
        text = "About",
        width = mui.getScaleVal(400),
