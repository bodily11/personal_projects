...
function scene:create( event )
    ...
    local function handleButtonEvent( event )
        ...
        composer.gotoScene("level_instructions", { effect = "crossFade", time = 500, params = {levelType = params["levelType"], difficulty = "easy"} } )
        return true
    end

    local function handleButtonEvent2( event )
        composer.removeScene("difficulty")
        composer.gotoScene("level_instructions", { effect = "crossFade", time = 500, params = {levelType = params["levelType"], difficulty = "medium"} } )
        return true
    end

    local function handleButtonEvent3( event )
        composer.removeScene("difficulty")
        composer.gotoScene("level_instructions", { effect = "crossFade", time = 500, params = {levelType = params["levelType"], difficulty = "hard"} } )
        return true
    end
